...
targetprefixes <- c("main/Results/DESeq2/allDEG_", "main/Results/GSEA-KEGG/GSEA_", "main/Results/GSEA-KEGG/GSEA_")
...
infile_GSEASets <- "main/Data/GSEA/BioMartforGSC_KEGG.tsv"


ntop <- 0.10        # will take the top ntop*100 % of DEGs to determine GSEA
